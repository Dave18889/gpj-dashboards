...
const SPREADSHEET_ID = process.env.SPREADSHEET_ID_2027;
...
async function fetchAll() {
  if (!API_KEY || !SPREADSHEET_ID) {
    throw new Error(
      'Missing GOOGLE_API_KEY or SPREADSHEET_ID_2027. Set them in .env locally, or in your Vercel project\'s Environment Variables.'
    );
  }
